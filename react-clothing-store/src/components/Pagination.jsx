...
const Pagination = () => {
    return (
        <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm text-center mt-8" aria-label="Pagination">
            ...
            <a href="#" aria-current="page" className="relative z-10 inline-flex items-center bg-black px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">1</a>
