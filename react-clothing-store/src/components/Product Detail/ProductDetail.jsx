            ...
            <div className="my-10 md:flex md:w-[80%] md:m-auto">
                <div className="w-auto flex flex-wrap items-center justify-between px-4 md:block md:mr-44">
                    {productImages.map((productImage, i) => (
                        <button key={i} onClick={() => setSelectedProductImage(productImage)} className="md:block">
                            <img  src={productImage} alt="productImage" className="w-auto h-[160px] object-cover mr-2 mb-8 lg:h-[120px]" />
                        </button>
                    ))}
                </div>
