        ...
        <>
            ...
            <div className="my-10">
                <div className="relative w-full px-4">
                    <div className="w-auto flex flex-wrap items-center justify-between">
                        {productImages.map((productImage, i) => (
                           <button onClick={() => setSelectedProductImage(productImage)}>
                                <img key={i} src={productImage} alt="productImage"  className="w-auto h-[160px] object-cover mr-2 mb-8"/>
                           </button> 
                        ))}
                    </div>
                </div>
            ...
            <div className="my-10">
                ...
                {activeTab == 'addtional-information' &&
                    <div className="px-3 text-justify mt-7">
